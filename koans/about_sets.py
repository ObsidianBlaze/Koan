...
class AboutSets(Koan):
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Wallace', 'MacLeod', 'Willie', 'Leonidas'}, scotsmen | warriors)
